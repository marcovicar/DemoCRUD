...
namespace DemoCRUD.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Autor,Titulo,AnoEdicao,Valor,GeneroId")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Autor,Titulo,AnoEdicao,Valor,GeneroId")] Livro livro)
        {
            if (ModelState.IsValid)
            {
